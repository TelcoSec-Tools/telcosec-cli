...
_telcosec() {
    ...
    local commands="check status hardware hw devices search find docs doc documentation sdr 10g 10gbe network firmware bitstreams profile 5g-sa 5g 5gsa scan academy feedback review version completion help"
